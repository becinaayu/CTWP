#9- Faça um programa que peça 10 números inteiros, calcule e mostre 
...
while i<10:
    ...
    while not num.isnumeric(): # Enquanto não for um número, faça isso:
        print("Tem que ser um inteiro!!")
        num = input(f"Diga o {i+1}º número: ") 
    num = int(num) # Transformando a o "num = input" em "int(input)"
    if num%2==0:
        qtd_pares += 1
    else:
        qtd_impares += 1
